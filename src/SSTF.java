public abstract class SSTF extends SCAN{
    ...
    public static void sstf(Disk disk){
    ...
    public static int serviceRequests(Disk disk){
        int headMovement = 0;
    ...
    public static int[] path(Disk disk){
    ...
    static int closest(int k, int[] requests, Disk disk){
        int min = 5000000;
        int minPos = -1;
        for (int i = 0; i < disk.numberOfRequest; i++){
